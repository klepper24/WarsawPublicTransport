...
MONGO_HOST = os.getenv('MONGO_HOST', default='git-mongo-python-1')
#MONGO_HOST = 'git-mongo-python-1'
...
MSSQL_HOST = os.getenv('MSSQL_HOST', default='git-ms-sql-1')
...
POSTGRES_URL = "postgresql://my_user:password123@git-postgres-db-1:5432/WarsawTransportState"